...
# Loading the data from the file 'data.Rdata' to the data array 'mydata' 
mydata=get(load("D:/MATH5793/Lab1Intro/data.Rdata"))

# Showing the first few rows of the data array
head(mydata)

# Finding the mean vector for the data array using the function mean_vector()
Lab1Intro::mean_vector(mydata)

# Finding the covariance matrix for the data array using the function covariance_matrix()
Lab1Intro::covariance_matrix(mydata)

# Finding the correlation matrix for the data array using the function correlation_matrix()
Lab1Intro::correlation_matrix(mydata)
```
